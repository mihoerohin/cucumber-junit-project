...
public class GoogleSearch {
    ...
    public void userShouldBeAbleToSearchForFollowing(List<String> searchKeywords) {
        ...
        System.out.println("All search keywords = " + searchKeywords);
        ...
        for (String each : searchKeywords) {
            ...
            System.out.println("Search keywords = " + each);
        }
    ...
    public void user_should_see_in_the_page(String capitalCity) {
